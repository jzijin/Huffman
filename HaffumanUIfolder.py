...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "文件夹压缩与解压"))
        self.label_compress.setText(_translate("Form", "请选择要压缩的文件夹"))
        self.pushButton_open_path.setText(_translate("Form", "打开"))
        self.pushButton_compress.setText(_translate("Form", "压缩"))
        self.label_decompress.setText(_translate("Form", "请选择要解压的文件夹"))
